    ...
    return(
        <CModal style={{backgroundColor:"rgba(0,0,0,0.2)"}}>
          <div style={{position:"relative",textAlign:"center",marginTop:"100%",}}>
            <div style={{position:"relative",display:"inline-block",backgroundColor:"white",borderRadius:"4px",textAlign:"center",verticalAlign:"middle",backgroundColor:"black",padding:"10px"}}>
              {this.props.children}
            </div>
          </div>
        </CModal>
